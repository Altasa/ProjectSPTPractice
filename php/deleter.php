            ...
            if($data==$dbpassw){
                if($emailstat==1){
                    ...
                    $message = '
                            ...
                            <p>Если Вы этого не делали, пожалуйста, смените пароль и сообщите администрации сайта: <a href="http://f1003067.xsph.ru/index.html">Перейти на сайт</a></p>
                            <br>
                            <p>Чтобы подтвердить удаление, перейдите по ссылке: <a href="http://f1003067.xsph.ru/php/deleter_email.php?hash='.$hash.'">Подтвердить удаление</a></p>
